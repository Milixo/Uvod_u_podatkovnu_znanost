...
extern FILE *fin; /* citamo iz ove datoteke */

/* Definirajte YY_INPUT tako da čitamo iz datoteke fin:
 *Ova promjena omogućava korištenje 
 * ovog skenera u Cool kompajleru.
 */
#undef YY_INPUT
...
char string_buf[MAX_STR_CONST]; /* Sastaviti nizove konstanti. */
char *string_buf_pt;
...
/*
 *  Dodajte svoje definicije ovdje
 */
